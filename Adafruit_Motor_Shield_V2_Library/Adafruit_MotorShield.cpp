...
void Adafruit_StepperMotor::setSpeed(uint16_t rpm) {
  ...
  //usperstep = 60*1000*1000 / (uint32_t)revsteps / (uint32_t)rpm;
  this->usperstep = 60L * 1000L * 1000L / (this->revsteps * rpm);
  //Serial.print("steps per rev: "); Serial.println(revsteps);
  //Serial.print("RPM: "); Serial.println(rpm);
  //Serial.print("Speed: "); Serial.println(usperstep);*/
}
...
/*  while (steps--) {
    //Serial.print("step! "); Serial.println(uspers/1000);
